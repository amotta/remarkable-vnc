// Adapted from rust-vnc by whitequark
...
impl Message for Vec<u8> {
    fn read_from<R: Read>(reader: &mut R) -> Result<Vec<u8>> {
        let length = reader.read_u32_from_be()?;
...
impl Message for String {
    fn read_from<R: ReadBytesExt>(reader: &mut R) -> Result<String> {
        let length = reader.read_u32_from_be()?;
...
impl Message for SecurityResult {
    fn read_from<R: Read>(reader: &mut R) -> Result<SecurityResult> {
        let result = reader.read_u32_from_be()?;
        match result {
...
impl Message for AppleAuthHandshake {
    fn read_from<R: Read>(reader: &mut R) -> Result<Self> {
        let generator = reader.read_u16_from_be()?;
        let key_length = reader.read_u16_from_be()?;
...
impl Message for PixelFormat {
    fn read_from<R: Read>(reader: &mut R) -> Result<PixelFormat> {
        let pixel_format = PixelFormat {
            ...
            red_max:        reader.read_u16_from_be()?,
            green_max:      reader.read_u16_from_be()?,
            blue_max:       reader.read_u16_from_be()?,
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        ...
        writer.write_u16_as_be(self.red_max)?;
        writer.write_u16_as_be(self.green_max)?;
        writer.write_u16_as_be(self.blue_max)?;
...
impl Message for ServerInit {
    fn read_from<R: Read>(reader: &mut R) -> Result<ServerInit> {
        Ok(ServerInit {
            framebuffer_width:  reader.read_u16_from_be()?,
            framebuffer_height: reader.read_u16_from_be()?,
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        writer.write_u16_as_be(self.framebuffer_width)?;
        writer.write_u16_as_be(self.framebuffer_height)?;
...
impl Message for CopyRect {
    fn read_from<R: Read>(reader: &mut R) -> Result<CopyRect> {
        Ok(CopyRect {
            src_x_position: reader.read_u16_from_be()?,
            src_y_position: reader.read_u16_from_be()?
        })
    }

    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        writer.write_u16_as_be(self.src_x_position)?;
        writer.write_u16_as_be(self.src_y_position)?;
        Ok(())
    }
}
*/
...
impl Message for Encoding {
    fn read_from<R: Read>(reader: &mut R) -> Result<Encoding> {
        let encoding = reader.read_i32_from_be()?;
        match encoding {
            0    => Ok(Encoding::Raw),
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        ...
        writer.write_i32_as_be(encoding)?;
        Ok(())
    }
}
    ...
    fn read_from<R: Read>(reader: &mut R) -> Result<C2S> {
        ...
        match message_type {
            ...
            2 => {
                ...
                let count = reader.read_u16_from_be()?;
            ...
            3 => {
                Ok(C2S::FramebufferUpdateRequest {
                    ...
                    x_position:  reader.read_u16_from_be()?,
                    y_position:  reader.read_u16_from_be()?,
                    width:       reader.read_u16_from_be()?,
                    height:      reader.read_u16_from_be()?
                })
            },
            4 => {
                let down = reader.read_u8()? != 0;
                reader.read_exact(&mut [0u8; 2])?;
                let key = reader.read_u32_from_be()?;
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        match self {
            ...
            C2S::SetEncodings(ref encodings) => {
                ...
                writer.write_u16_as_be(encodings.len() as u16)?; // TODO: check?
            ...
            C2S::FramebufferUpdateRequest { incremental, x_position, y_position, width, height } => {
                ...
                writer.write_u16_as_be(*x_position)?;
                writer.write_u16_as_be(*y_position)?;
                writer.write_u16_as_be(*width)?;
                writer.write_u16_as_be(*height)?;
            },
            C2S::KeyEvent { down, key } => {
                writer.write_u8(4)?;
                writer.write_u8(if *down { 1 } else { 0 })?;
                writer.write_all(&[0u8; 2])?;
                writer.write_u32_as_be(*key)?;
            },
...
impl Message for Rectangle {
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        writer.write_u16_as_be(self.x_position)?;
        writer.write_u16_as_be(self.y_position)?;
        writer.write_u16_as_be(self.width)?;
        writer.write_u16_as_be(self.height)?;
...
impl Message for Colour {
    fn read_from<R: Read>(reader: &mut R) -> Result<Colour> {
        Ok(Colour {
            red:   reader.read_u16_from_be()?,
            green: reader.read_u16_from_be()?,
            blue:  reader.read_u16_from_be()?
        })
    }

    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        writer.write_u16_as_be(self.red)?;
        writer.write_u16_as_be(self.green)?;
        writer.write_u16_as_be(self.blue)?;
        Ok(())
    }
}
        ...
        match message_type {
            0 => {
                ...
                Ok(S2C::FramebufferUpdate {
                    count: reader.read_u16_from_be()?
                })
            },
            1 => {
                reader.read_exact(&mut [0u8; 1])?;
                let first_colour = reader.read_u16_from_be()?;
                let count = reader.read_u16_from_be()?;
    ...
    fn write_to<W: Write>(&self, writer: &mut W) -> Result<()> {
        match self {
            S2C::FramebufferUpdate { count } => {
                writer.write_u8(0)?;
                writer.write_all(&[0u8; 1])?;
                writer.write_u16_as_be(*count)?;
            },
            S2C::SetColourMapEntries { first_colour, ref colours } => {
                writer.write_u8(1)?;
                writer.write_all(&[0u8; 1])?;
                writer.write_u16_as_be(*first_colour)?;
